...
lib Xutil
  ...
  struct WMHints
    ...
    icon_pixmap : Xlib::Pixmap # pixmap to be used as icon
    icon_window : X11::Window # window to be used as icon
    icon_x, icon_y : Int32 # initial position of icon
    icon_mask : Xlib::Pixmap # icon mask bitmap
    window_group : X11::XID # id of related window group
  ...
  struct TextProperty
    value : X11::PUInt8 # same as Property routines
    encoding : X11::Atom # prop type
  ...
  struct ComposeStatus
    compose_ptr : Xlib::Pointer # state table pointer
    chars_matched : Int32 # match state
  end

  # opaque reference to Region data type
  alias Region = Xregion::REGION*
  ...
  struct StandardColormap
    colormap : X11::Colormap
	  ...
	  blue_mult : UInt64
	  base_pixel : UInt64
    visualid : X11::VisualID # added by ICCCM version 1
    killid : X11::XID # added by ICCCM version 1
  end
  ...
  fun clip_box = XClipBox(
    r : Region,
    rect_return : Xlib::PRectangle
  ) : Int32

  fun create_region = XCreateRegion(
  ) : Region

  fun default_string = XDefaultString() : X11::PChar
  ...
  fun lookup_string = XLookupString(
    event_struct : Xlib::PKeyEvent,
    buffer_return : X11::PChar,
    bytes_buffer : Int32,
    keysym_return : X11::PKeySym,
  ...
  fun wm_geometry = XWMGeometry(
    display : Xlib::PDisplay,
    screen_number : Int32,
    user_geometry : X11::PChar,
    default_geometry : X11::PChar,
    border_width : UInt32,
    hints : PSizeHints,
    x_return : X11::PInt32,
    y_return : X11::PInt32,
    width_return : X11::PInt32,
    height_return : X11::PInt32,
    gravity_return : X11::PInt32
  ) : Int32
